...
$(document).on('click', '#button-login, #button-register, #button-guest', function() {
	$('#nav-address').html('<a href="#tab-address" data-toggle="tab" class="nav-link font-weight-bold" role="tab" aria-controls="tab-address">Address</a>');
...
$(document).on('click', '#button-address', function() {
	$('#nav-method').html('<a href="#tab-method" data-toggle="tab" class="nav-link font-weight-bold" role="tab" aria-controls="tab-method">Method</a>');

	$('a[href=\'#tab-method\']').tab('show');
});
